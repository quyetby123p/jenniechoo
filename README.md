...
- `RECONCILE_COD_HOUR` (gio chay tu dong, mac dinh `9`)
- `RECONCILE_COD_MINUTE` (phut chay tu dong, mac dinh `30`)
- `RECONCILE_COD_AUTO_WEEKDAYS` (danh sach thu chay bao cao tien ve, format `0-6` voi `0=T2`, `6=CN`, mac dinh `0,1,2,3,4,5,6`)
